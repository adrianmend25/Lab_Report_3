...
## Config file
![config](LR3-config.png)

## Login with alias
![simple_login](LR3-simple_login.png)

## File copy using alias
![alias_copy](LR3-alias_copy.png)


# Setup Github Access from ieng6

## Public key on GitHub
![public_key](LR3-public_key.png)

## Private key on user account
![private_key](LR3-private_key.png)

## Commit and push changes using git commands
![git_commands](LR3-gitcommands.png)
...
![directory_copy](LR3-directory_copy.png)

## Logging onto ieng6 and compliling and runnning tests
![ieng6_tests](LR3-ieng6_tests.png)

## Copy directory and run tests in one line
![one_line](LR3-one_line.png)
